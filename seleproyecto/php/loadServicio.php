...
while ($servicios = mysqli_fetch_assoc($result)) {
    ...
    //$imagenesSQL = "select img.nom_img from imagenes_alojamientos as img where img.fk_idal = '".$servicios['pk_idal']."'";
    //$queryIMG = mysqli_query($con, $imagenesSQL);

    //$imagenes = mysqli_fetch_array($queryIMG);  
